              ...
              GridView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return GestureDetector(
                    onTap: () {
                      Navigator.of(context).push(MaterialPageRoute(builder: (context) => StorageScreen(name: storage.name)));
                    },
                    child: CardWidget(
                      contentPadding: EdgeInsets.symmetric(horizontal: 0.5.w, vertical: 0.2.h),
                      title: "${storage.size.toSize(decimals: 0)} - ${storage.type.name}",
                      child: Stack(
                        children: [
                          Align(
                            ...
                            child: Text(
                              ...
                              style: Theme.of(context).textTheme.labelLarge!.copyWith(color: getTemperatureColor(storage.temperature)),
                            ),
                          ),
                          Row(
